...
const Newsletter = () => {
  ...
  <div className="container mx-auto flex flex-col px-5 py-24 justify-center items-center">
    <div className="w-full md:w-2/3 flex flex-col mb-2 items-center text-center">
      <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-white">Join Us Our Newsletter</h1>
      <p className="mb-8 leading-relaxed">to get updated from our new offers</p>
      ...
      <p className="text-sm mt-2 text-gray-500 mb-8 w-full">Dont worry we will not spam you 🙂</p>
