...
const LoginForm = () => {
  ...
  const prevLoc = searchParams.get('prevlocation')
  ...
  const postData=async(e)=>{
    try{
      ...
      // console.log(res);
      // console.log("loginForm",res.status);
      if(res.status === 200){
        await LogIn()
...
<div>
  ...
  <strong className="font-bold">Wrong Credendtial:</strong>
          ...
          <form>
            ...
            <div className="flex -mx-3">
              <div className="w-full px-3 mb-5">
                <label htmlFor="email" className="text-xs font-semibold px-1">Email/username</label>
                <div className="flex">
                  ...
                  <input type="email" require="true" name="email" onChange={dataHandler} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-[#BEA058]" placeholder="johnsmith@example.com" />
                </div>
              </div>
            </div>
            <div className="flex -mx-3">
              <div className="w-full px-3 mb-12">
                ...
                <div className="flex">
                  ...
                  <input type="password" required name="password" onChange={dataHandler} className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-[#BEA058]" placeholder="************" />
                </div>
              </div>
            </div>
            <div className="flex -mx-3">
              <div className="w-full px-3 mb-5">
                <button type='submit' className="block w-full max-w-xs mx-auto bg-[#BEA058] hover:bg-[#E0C670] focus:bg-[#E0C670] text-white rounded-lg px-3 py-3 font-semibold" onClick={postData} >LOGIN</button>
              </div>
            </div>
            </form>
            <p className='text-center'>Not have an Account yet?<Link to="/register" className='text-blue-900'>Register Now</Link></p>
        </div>
      </div>
    </div>
  </div>
